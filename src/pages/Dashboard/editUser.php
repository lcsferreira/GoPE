...
<body>
  ...
  function editUser(payload) {
    ...
    $.ajax({
      ...
      //   window.location.href = '../../pages/Dashboard/editUser.php?id=<?php echo $id; ?>&success=true'
      // } else {
      //   window.location.href = '../../pages/Dashboard/editUser.php?id=<?php echo $id; ?>&error=true'
      // }
    });
  }

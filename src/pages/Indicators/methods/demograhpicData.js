const methods = [
  ...
  },
  {
    ...
    html: "<p>Most recent data from the UNESCO Institute for Statistics. To find the information, enter the provided link and follow these steps: on the main page, select ‘Education’ – ‘Other policy relevant indicators’ – ‘Official entrance age and theoretical duration of each level of education (years)’ – ‘Official entrance age’ – ‘Official entrance age of each ISCED level of education’. On the available table, select ‘Official entrance age to primary education (years)’.<br>Use the same value as in 'Official entrance age to primary secondary education (years)'. For ‘primary education’ we use as reference The ISCED level 1 (primary education) that usually begins between four and seven years of age, is compulsory in all countries and generally lasts from five to six years (UNESCO, 2012).<br><a href='http://data.uis.unesco.org/'>http://data.uis.unesco.org/</a><br>[accessed in April 23rd, 2024]<br>For England and Scotland:<br>- OECD. (2023). Education at a Glance 2023: OECD indicators. OECD Publishing.<br><a href='https://doi.org/10.1787/e13bef63-en'>https://doi.org/10.1787/e13bef63-en</a></p>",
  },
  {

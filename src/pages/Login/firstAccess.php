...
$token = $_GET['tk'];
// the token is the email (primary key) encrypted with md5
// $email = md5($token);
$email = $token;

// Prepare and execute the query
$sql = "SELECT * FROM users WHERE email = '$email' AND active = 1 AND password IS NOT NULL";
  ...
  <div class="form-container">
    <div class="form-content">
      ...
      <p class="form__description">
        ...
        <br>
        We'll <strong>redirect</strong> you to <strong>sign in </strong> area.
      </p>

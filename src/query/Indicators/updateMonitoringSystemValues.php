...
$sql = "UPDATE pe_monitoring_monitoring_systems_".$payload["type"]." SET reach = ".$payload['reach'] .", curriculum_implementation = ".$curriculumImplementation.", pe_general_school = ".$peGeneralSchool.", min_time = ".$minTime.", other = ".$other.", other_purposes = '".$payload['otherPurposes']."', education_level = '".$payload['educationLevel']."', years_applied = '".$payload['yearsApplied']."', year_publication = '".$payload['yearPublication']."', years_application = '".$payload['yearsApplication']."' WHERE id_country = ".$id . " AND inc = " . $inc;
